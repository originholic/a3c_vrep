...
class CartPole:
    ...
    def takeAction(self, doubleAction):
        ...
        # action has range of [-1., +1.]
        force = doubleAction * self.max_force          
    ...
    def terminate(self):
        ...
        """
        return abs(self.cart_location) > self.state_range[0,1] or abs(self.pole_angle) > self.state_range[2,1]
